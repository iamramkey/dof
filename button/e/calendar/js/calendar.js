...
function loadData() {
        ...
        success: function (data) {
            ...
            $.ajax({
                ...
                success: function (data1) {
                    ...
                    document.getElementById('chart1').style.height = ($('.cont').width()/58 * 7 + 150) + 'px';
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            document.getElementById('chart2').style.height = ($('.cont').width()/58 * 7 + 150) + 'px';
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            document.getElementById('chart3').style.height = ($('.cont').width()/58 * 7 + 150) + 'px';
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            document.getElementById('chart4').style.height = ($('.cont').width()/58 * 7 + 150) + 'px';
