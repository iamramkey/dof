...
function XmlLoaded() {
	...
	var tabledata = [];
	globeldata.dailyChartData=[
		['Daily','count', {type: 'string', role: 'annotation'}]
	];
	globeldata.pending = [
		['Team', 'count']
	];
...
function drawLocationChart(){
	...
	var options = {
		...
		chartArea: {left: "7%", top: 20, width: "90%", height: "70%"},
...
function drawTOA(){
	...
	var options = {
		...
		chartArea: {left: "7%", top: 20, width: "90%", height: "70%"},
		hAxis: { direction: -1, slantedText: true, slantedTextAngle: 40 , textStyle: {color: '#FFF'}},
		vAxis:{textStyle: {color: '#FFF'}, gridlines: {
			color: 'transparent'
		}},
		backgroundColor: '#171717'
	};
...
function drawChart() {
	...
	var options = {
		...
		fontSize:13,
		legend: {position: 'none'},
		chartArea: {left: "5%", top: 20, width: "91%", height: "60%"},
		hAxis: { direction: -1, slantedText: true, slantedTextAngle: 40, textStyle: {color: '#FFF'} },
		vAxis: {textStyle: {color: '#FFF'}, gridlines: {
			color: 'transparent'
		}},
